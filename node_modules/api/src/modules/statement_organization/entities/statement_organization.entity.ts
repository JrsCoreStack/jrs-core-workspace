...
@Entity('erp_statement_organization')
export class StatementOrganizationEntity {
  ...
  @ManyToOne(
    () => TransactionEntity,
    (transaction) => transaction.statements_organization,
    {
      onDelete: 'CASCADE',
    },
  )
  ...
  @ManyToOne(
    () => StatementTypeEntity,
    (statementType) => statementType.statements_organization,
    {
      onDelete: 'CASCADE',
    },
  )
