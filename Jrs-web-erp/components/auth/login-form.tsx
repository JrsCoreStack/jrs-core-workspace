...
export function LoginForm({ onSwitchToRegister, onLogin }: LoginFormProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex w-full">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-gradient(to-br, from-primary/20 via-background to-background) relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-md">
              Sistema integrado para gestão de eventos, ingressos e muito mais.
            </p>

            <div className="flex gap-4">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-4 flex-1">
        ...
        <Card className="w-full max-w-md border-border bg-card">
          <CardHeader className="space-y-1 text-center">
            <div className="flex items-center justify-center gap-2 lg:hidden mb-4">
              ...
              <span className="text-xl font-bold">OTicket</span>
            </div>
